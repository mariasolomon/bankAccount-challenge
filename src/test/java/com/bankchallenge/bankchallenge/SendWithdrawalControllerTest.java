...
public class SendWithdrawalControllerTest {
    @Autowired
	...
	public void sendWithdrawal() throws Exception {
        ...
        Transaction operation = new Transaction(acc.getId(), 500,TRANSACTION_TYPE.WITHDRAWAL);

		this.mockMvc.perform(post("/transactions/withdraw")
            .contentType(contentType)
    ...
    public void should_Return404_When_AccountNotFound() throws Exception {
        Transaction operation = new Transaction(7517, 500,TRANSACTION_TYPE.WITHDRAWAL);
